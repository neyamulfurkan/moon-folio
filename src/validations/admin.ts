...
export const settingsSchema = z.object({
  ...
  hero_scene_1_accent_color: z.string().optional(),
  hero_scene_2_eyebrow: z.string().optional(),
  hero_scene_2_headline: z.string().optional(),
  hero_scene_2_supporting: z.string().optional(),
  hero_scene_2_accent_color: z.string().optional(),
  hero_scene_3_eyebrow: z.string().optional(),
  hero_scene_3_headline: z.string().optional(),
  hero_scene_3_supporting: z.string().optional(),
  hero_scene_3_accent_color: z.string().optional(),
  profile_photo_url: z.string().optional(),
  availability_status: z.string().optional(),
  availability_label: z.string().optional(),
  testimonial_1_name: z.string().optional(),
  testimonial_1_role: z.string().optional(),
  testimonial_1_text: z.string().optional(),
  testimonial_2_name: z.string().optional(),
  testimonial_2_role: z.string().optional(),
  testimonial_2_text: z.string().optional(),
  testimonial_3_name: z.string().optional(),
  testimonial_3_role: z.string().optional(),
  testimonial_3_text: z.string().optional(),
